...
__sfr __at(0xD0) PSW; // Program Status Word      CY    AC    F0    RS1   RS0 OV
                      // F1    P    0000,0000
//-----------------------------------
...
//                                          7     6      5    4     3      2 1
//                                          0     Reset Value
__sfr __at(0x87) PCON; // Power Control        SMOD  SMOD0  LVDF  POF   GF1 GF0
                       // PD   IDL    0001,0000
//                                        7     6       5      4     3      2 1
//                                        0   Reset Value
__sfr __at(0x8E) AUXR; // Auxiliary Register  T0x12 T1x12 UART_M0x6 BRTR S2SMOD
                       // BRTx12 EXTRAM S1BRS  0000,0000
//-----------------------------------
__sfr __at(0xA2) AUXR1; // Auxiliary Register 1  -  PCA_P4  SPI_P4  S2_P4  GF2
                        // ADRJ   -    DPS  0000,0000
/*
PCA_P4:
    0, 缺省PCA 在P1 口
...
/*
      7            6          5          4          3       2       1      0
Reset Value PCAWAKEUP  RXD_PIN_IE  T1_PIN_IE  T0_PIN_IE  LVD_WAKE    _    T1CLKO
T0CLKO      0000,0000B

b7 - PCAWAKEUP : PCA 中断可唤醒 powerdown。
b6 - RXD_PIN_IE : 当 P3.0(RXD) 下降沿置位 RI 时可唤醒
powerdown(必须打开相应中断)。 b5 - T1_PIN_IE : 当 T1 脚下降沿置位 T1
中断标志时可唤醒 powerdown(必须打开相应中断)。 b4 - T0_PIN_IE : 当 T0
脚下降沿置位 T0 中断标志时可唤醒 powerdown(必须打开相应中断)。 b3 - LVD_WAKE :
当 CMPIN 脚低电平置位 LVD 中断标志时可唤醒 powerdown(必须打开相应中断)。 b2 - b1
- T1CLKO : 允许 T1CKO(P3.5) 脚输出 T1 溢出脉冲，Fck1 = 1/2 T1 溢出率 b0 - T0CLKO
: 允许 T0CKO(P3.4) 脚输出 T0 溢出脉冲，Fck0 = 1/2 T1 溢出率
*/
//-----------------------------------
__sfr __at(0x97) CLK_DIV; // Clock Divder          -     -      -       -     -
                          // CLKS2 CLKS1 CLKS0 xxxx,x000
//-----------------------------------
__sfr __at(0xA1) BUS_SPEED; // Stretch register      -     -    ALES1   ALES0 -
                            // RWS2  RWS1  RWS0 xx10,x011
/*
ALES1 and ALES0:
00 : The P0 address setup time and hold time to ALE negative edge is one clock
cycle 01 : The P0 address setup time and hold time to ALE negative edge is two
clock cycles. 10 : The P0 address setup time and hold time to ALE negative edge
is three clock cycles. (default) 11 : The P0 address setup time and hold time to
ALE negative edge is four clock cycles.
...
//                                           7     6     5    4     3    2    1
//                                           0   Reset Value
__sfr __at(0xA8) IE; // 中断控制寄存器        EA  ELVD  EADC   ES   ET1  EX1 ET0
                     // EX0  0x00,0000
//-----------------------
...
//-----------------------
__sfr __at(0xAF) IE2; // Auxiliary Interrupt   -     -     -    -     -    -
                      // ESPI  ES2  0000,0000B
//-----------------------
//                                          7     6     5    4    3    2    1 0
//                                          Reset Value
__sfr __at(0xB8) IP; // 中断优先级低位      PPCA  PLVD  PADC  PS   PT1  PX1  PT0
                     // PX0   0000,0000
//--------
...
//                                         7      6      5     4     3     2 1
//                                         0    Reset Value
__sfr __at(0xB7) IPH; // 中断优先级高位       PPCAH  PLVDH  PADCH  PSH  PT1H
                      // PX1H  PT0H  PX0H   0000,0000
__sfr __at(0xB5) IP2; //                       -      -      -     -     -     -
                      //                       PSPI   PS2   xxxx,xx00
...
//                                      7     6     5     4     3     2     1 0
//                                      Reset Value
__sfr __at(0x80) P0; // 8 bitPort0          P0.7  P0.6  P0.5  P0.4  P0.3  P0.2
                     // P0.1  P0.0       1111,1111
...
__sfr __at(0x93)
    P0M1; //                                                                         0000,0000
__sfr __at(0x90) P1; // 8 bitPort1          P1.7  P1.6  P1.5  P1.4  P1.3  P1.2
                     // P1.1  P1.0       1111,1111
...
__sfr __at(0xA0) P2; // 8 bitPort2          P2.7  P2.6  P2.5  P2.4  P2.3  P2.2
                     // P2.1  P2.0       1111,1111
...
__sfr __at(0x95)
    P2M1; //                                                                         0000,0000
__sfr __at(0xB0) P3; // 8 bitPort3          P3.7  P3.6  P3.5  P3.4  P3.3  P3.2
                     // P3.1  P3.0       1111,1111
...
__sfr __at(0xB1)
    P3M1; //                                                                         0000,0000
__sfr __at(0xC0) P4; // 8 bitPort4          P4.7  P4.6  P4.5  P4.4  P4.3  P4.2
                     // P4.1  P4.0       1111,1111
...
//                                      7      6         5         4      3 2 1
//                                      0     Reset Value
__sfr __at(0xBB) P4SW; // Port-4 switch        -   LVD_P4.6  ALE_P4.5  NA_P4.4
                       // -     -     -     -       x000,xxxx

__sfr __at(0xC8) P5; // 8 bitPort5           -     -       -      -    P5.3 P5.2
                     // P5.1  P5.0    xxxx,1111
...
//                                          7     6     5     4     3     2 1 0
//                                          Reset Value
__sfr __at(0x88) TCON; // T0/T1 Control           TF1   TR1   TF0   TR0   IE1
                       // IT1   IE0   IT0    0000,0000
//-----------------------------------
...
//-----------------------------------
__sfr __at(0x89) TMOD; // T0/T1 Modes             GATE1 C/T1  M1_1  M1_0  GATE0
                       // C/T0  M0_1  M0_0   0000,0000
...
//                                          7     6     5     4     3     2 1 0
//                                          Reset Value
__sfr __at(0x98) SCON; // Serial Control         SM0/FE SM1   SM2   REN   TB8
                       // RB8    TI    RI    0000,0000
//-----------------------------------
...
//                                7      6      5      4      3      2     1 0
//                                Reset Value
__sfr __at(0x9A) S2CON; // S2 Control  S2SM0  S2SM1  S2SM2  S2REN  S2TB8  S2RB8
                        // S2TI  S2RI      00000000B
...
//                                      7     6     5      4       3      2   1
//                                      0     Reset Value
//                                  WDT_FLAG  -  EN_WDT CLR_WDT IDLE_WDT PS2 PS1
//                                  PS0    xx00,0000
//-----------------------
...
//                                         7     6     5     4     3     2     1
//                                         0     Reset Value
__sfr __at(0xD8) CCON; // PCA 控制寄存器。    CF    CR    -     -     -     -
                       // CCF1  CCF0   00xx,xx00
//-----------------------
...
//-----------------------
__sfr __at(0xD9) CMOD; // PCA 工作模式寄存器。   CIDL   -     -     -   CPS2
...
//                                         7     6      5      4     3     2 1
//                                         0     Reset Value
__sfr __at(0xDA) CCAPM0; // PCA 模块0 PWM 寄存器  -   ECOM0  CAPP0  CAPN0  MAT0
                         // TOG0  PWM0  ECCF0   x000,0000
__sfr __at(0xDB) CCAPM1; // PCA 模块1 PWM 寄存器  -   ECOM1  CAPP1  CAPN1  MAT1
...
//   x      1      1     0     0     0     x   0x31
//   16位CEXn边沿(上、下沿)触发捕捉功能。 1      0      0     1     0     0 x
//   0x49   16位软件定时器。 1      0      0     1     1     0     x   0x4d
//   16位高速脉冲输出。 1      0      0     0     0     1     0   0x42   8位
//   PWM。
...
//                                                       7   6   5   4   3   2
//                                                       1     0    Reset Value
__sfr __at(0xF2) PCA_PWM0; // PCA 模块0 PWM 寄存器。            -   -   -   - -
                           // -  EPC0H EPC0L   xxxx,xx00
__sfr __at(0xF3) PCA_PWM1; // PCA 模块1 PWM 寄存器。            -   -   -   - -
...
//                                             7        6      5       4 3 2 1
//                                             0   Reset Value
__sfr __at(0xBC) ADC_CONTR; // A/D 转换控制寄存器 ADC_POWER SPEED1 SPEED0
                            // ADC_FLAG ADC_START CHS2 CHS1 CHS0 0000,0000
__sfr __at(0xBD) ADC_RES;   // A/D 转换结果高8位 ADCV.9 ADCV.8 ADCV.7 ADCV.6
                            // ADCV.5 ADCV.4 ADCV.3 ADCV.2    0000,0000
__sfr __at(0xBE) ADC_RESL;  // A/D 转换结果低2位 ADCV.1 ADCV.0    0000,0000
//--------------------------------------------------------------------------------
// 新一代 1T 8051系列 单片机 SPI 特殊功能寄存器
//                                      7     6     5     4     3     2     1 0
//                                      Reset Value
__sfr __at(0xCE) SPCTL;  // SPI Control Register  SSIG  SPEN  DORD  MSTR  CPOL
                         // CPHA  SPR1  SPR0  0000,0100
__sfr __at(0xCD) SPSTAT; // SPI Status Register   SPIF  WCOL   -     -     - -
                         // -     -    00xx,xxxx
...
//                                                7    6    5      4    3    2
//                                                1     0    Reset Value
__sfr __at(0xC5) IAP_CMD; // IAP Mode Table          0    -    -      -    - -
                          // MS1   MS0   0xxx,xx00
__sfr __at(0xC6) IAP_TRIG;
__sfr __at(0xC7) IAP_CONTR; // IAP Control Register  IAPEN SWBS SWRST CFAIL  -
