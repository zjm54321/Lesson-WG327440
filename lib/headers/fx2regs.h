...
_SFR(0xab)
EP24FIFOFLGS; ///< Register 0xAB: Endpoint 2,4 slave FIFO status flags
_SFR(0xac)
EP68FIFOFLGS; ///< Register 0xAC: Endpoint 6,8 slave FIFO status flags
...
_SFR(0xbb)
GPIFTRIG; ///< Register 0xBB: Endpoint 2,4,6,8 GPIF slave FIFO Trigger
...
_SBIT(0xc8 + 0)
CPRL2;               ///< Register 0xC8 bit 0: Timer/Counter 2 Control bit CPRL2
...
_SBIT(0xc8 + 3)
EXEN2; ///< Register 0xC8 bit 3: Timer/Counter 2 Control bit EXEN2
...
_SFR(0xca)
RCAP2L; ///< Register 0xCA: Capture for Timer 2, auto-reload, up-counter
_SFR16(0xcbca)
RCAP2; ///< Register 0xCA: Capture for Timer 2, auto-reload, up-counter
_SFR(0xcb)
RCAP2H;         ///< Register 0xCB: Capture for Timer 2, auto-reload, up-counter
...
_SBIT(0xd8 + 4)
INT6; ///< Register 0xD8 bit 4: External Interrupt Control SMOD1 bit INT6
_SBIT(0xd8 + 5)
RESI; ///< Register 0xD8 bit 5: External Interrupt Control SMOD1 bit RESI
_SBIT(0xd8 + 6)
ERESI; ///< Register 0xD8 bit 6: External Interrupt Control SMOD1 bit ERESI
...
_SBIT(0xe8 + 0)
EUSB; ///< Register 0xE8 bit 0: External Interrupt Enable(s) bit EUSB
_SBIT(0xe8 + 1)
EI2C; ///< Register 0xE8 bit 1: External Interrupt Enable(s) bit EI2C
_SBIT(0xe8 + 2)
EX4; ///< Register 0xE8 bit 2: External Interrupt Enable(s) bit EX4
_SBIT(0xe8 + 3)
EX5; ///< Register 0xE8 bit 3: External Interrupt Enable(s) bit EX5
_SBIT(0xe8 + 4)
EX6;          ///< Register 0xE8 bit 4: External Interrupt Enable(s) bit EX6
...
_SBIT(0xf8 + 1)
PUSB; ///< Register 0xF8 bit 1: External Interrupt Priority 1 Control bit PUSB
_SBIT(0xf8 + 2)
PI2C; ///< Register 0xF8 bit 2: External Interrupt Priority 1 Control bit PI2C
_SBIT(0xf8 + 3)
PX4; ///< Register 0xF8 bit 3: External Interrupt Priority 1 Control bit PX4
_SBIT(0xf8 + 4)
PX5; ///< Register 0xF8 bit 4: External Interrupt Priority 1 Control bit PX5
_SBIT(0xf8 + 5)
PX6; ///< Register 0xF8 bit 5: External Interrupt Priority 1 Control bit PX6

// GPIF Waveform Memories

_IOR(0xe400)
WAVEDATA[128]; ///< Register 0xE400: GPIF Waveform Descriptor 0, 1, 2, 3 data

// General Configuration

_IOR(0xe50d)
GPCR2; ///< Register 0xE50D: General Purpose Configuration Register 2
_IOR(0xe600) CPUCS; ///< Register 0xE600: CPU Control & Status
_IOR(0xe601)
IFCONFIG; ///< Register 0xE601: Interface Configuration (Ports, GPIF, slave
          ///< FIFOs)
_IOR(0xe602)
PINFLAGSAB; ///< Register 0xE602: Slave FIFO FLAGA and FLAGB Pin Configuration
_IOR(0xe603)
PINFLAGSCD; ///< Register 0xE603: Slave FIFO FLAGC and FLAGD Pin Configuration
...
_IOR(0xe608)
UART230; ///< Register 0xE608: 230 Kbaud internally generated ref. clock
_IOR(0xe609)
FIFOPINPOLAR;        ///< Register 0xE609: Slave FIFO Interface pins polarity
...
_IOR(0xe618)
EP2FIFOCFG; ///< Register 0xE618: Endpoint 2 / slave FIFO configuration
_IOR(0xe619)
EP4FIFOCFG; ///< Register 0xE619: Endpoint 4 / slave FIFO configuration
_IOR(0xe61a)
EP6FIFOCFG; ///< Register 0xE61A: Endpoint 6 / slave FIFO configuration
_IOR(0xe61b)
EP8FIFOCFG; ///< Register 0xE61B: Endpoint 8 / slave FIFO configuration
_IOR(0xe620)
EP2AUTOINLENH; ///< Register 0xE620: Endpoint 2 AUTOIN Packet Length H
_IOR(0xe621)
EP2AUTOINLENL; ///< Register 0xE621: Endpoint 2 AUTOIN Packet Length L
_IOR(0xe622)
EP4AUTOINLENH; ///< Register 0xE622: Endpoint 4 AUTOIN Packet Length H
_IOR(0xe623)
EP4AUTOINLENL; ///< Register 0xE623: Endpoint 4 AUTOIN Packet Length L
_IOR(0xe624)
EP6AUTOINLENH; ///< Register 0xE624: Endpoint 6 AUTOIN Packet Length H
_IOR(0xe625)
EP6AUTOINLENL; ///< Register 0xE625: Endpoint 6 AUTOIN Packet Length L
_IOR(0xe626)
EP8AUTOINLENH; ///< Register 0xE626: Endpoint 8 AUTOIN Packet Length H
_IOR(0xe627)
EP8AUTOINLENL;         ///< Register 0xE627: Endpoint 8 AUTOIN Packet Length L
...
_IOR(0xe630)
EP2FIFOPFH; ///< Register 0xE630: Endpoint 2 / slave FIFO Programmable Flag H
_IOR(0xe631)
EP2FIFOPFL; ///< Register 0xE631: Endpoint 2 / slave FIFO Programmable Flag L
_IOR(0xe632)
EP4FIFOPFH; ///< Register 0xE632: Endpoint 4 / slave FIFO Programmable Flag H
_IOR(0xe633)
EP4FIFOPFL; ///< Register 0xE633: Endpoint 4 / slave FIFO Programmable Flag L
_IOR(0xe634)
EP6FIFOPFH; ///< Register 0xE634: Endpoint 6 / slave FIFO Programmable Flag H
_IOR(0xe635)
EP6FIFOPFL; ///< Register 0xE635: Endpoint 6 / slave FIFO Programmable Flag L
_IOR(0xe636)
EP8FIFOPFH; ///< Register 0xE636: Endpoint 8 / slave FIFO Programmable Flag H
_IOR(0xe637)
EP8FIFOPFL; ///< Register 0xE637: Endpoint 8 / slave FIFO Programmable Flag L
_IOR(0xe640)
EP2ISOINPKTS; ///< Register 0xE640: EP2 (if ISO) IN Packets per frame (1-3)
_IOR(0xe641)
EP4ISOINPKTS; ///< Register 0xE641: EP4 (if ISO) IN Packets per frame (1-3)
_IOR(0xe642)
EP6ISOINPKTS; ///< Register 0xE642: EP6 (if ISO) IN Packets per frame (1-3)
_IOR(0xe643)
EP8ISOINPKTS; ///< Register 0xE643: EP8 (if ISO) IN Packets per frame (1-3)
...
_IOR(0xe650)
EP2FIFOIE; ///< Register 0xE650: Endpoint 2 slave FIFO Flag Interrupt Enable
_IOR(0xe651)
EP2FIFOIRQ; ///< Register 0xE651: Endpoint 2 slave FIFO Flag Interrupt Request
_IOR(0xe652)
EP4FIFOIE; ///< Register 0xE652: Endpoint 4 slave FIFO Flag Interrupt Enable
_IOR(0xe653)
EP4FIFOIRQ; ///< Register 0xE653: Endpoint 4 slave FIFO Flag Interrupt Request
_IOR(0xe654)
EP6FIFOIE; ///< Register 0xE654: Endpoint 6 slave FIFO Flag Interrupt Enable
_IOR(0xe655)
EP6FIFOIRQ; ///< Register 0xE655: Endpoint 6 slave FIFO Flag Interrupt Request
_IOR(0xe656)
EP8FIFOIE; ///< Register 0xE656: Endpoint 8 slave FIFO Flag Interrupt Enable
_IOR(0xe657)
EP8FIFOIRQ; ///< Register 0xE657: Endpoint 8 slave FIFO Flag Interrupt Request
...
_IOR(0xe65a)
NAKIE; ///< Register 0xE65A: Endpoint Ping-NAK / IBN Interrupt Enable
_IOR(0xe65b)
NAKIRQ; ///< Register 0xE65B: Endpoint Ping-NAK / IBN Interrupt Request
...
_IOR(0xe667)
INT4IVEC; ///< Register 0xE667: Interrupt 4 (slave FIFO & 1 GPIF) Autovector
...
_IOR(0xe67b)
XAUTODAT1; ///< Register 0xE67B: Autoptr1 MOVX access, when APTREN=1
_IOR(0xe67c)
XAUTODAT2;             ///< Register 0xE67C: Autoptr2 MOVX access, when APTREN=1
...
_IOR(0xe6ab)
EP2FIFOBCH; ///< Register 0xE6AB: Endpoint 2 slave FIFO total byte count H
_IOR(0xe6ac)
EP2FIFOBCL; ///< Register 0xE6AC: Endpoint 2 slave FIFO total byte count L
_IOR(0xe6ad)
EP4FIFOBCH; ///< Register 0xE6AD: Endpoint 4 slave FIFO total byte count H
_IOR(0xe6ae)
EP4FIFOBCL; ///< Register 0xE6AE: Endpoint 4 slave FIFO total byte count L
_IOR(0xe6af)
EP6FIFOBCH; ///< Register 0xE6AF: Endpoint 6 slave FIFO total byte count H
_IOR(0xe6b0)
EP6FIFOBCL; ///< Register 0xE6B0: Endpoint 6 slave FIFO total byte count L
_IOR(0xe6b1)
EP8FIFOBCH; ///< Register 0xE6B1: Endpoint 8 slave FIFO total byte count H
_IOR(0xe6b2)
EP8FIFOBCL; ///< Register 0xE6B2: Endpoint 8 slave FIFO total byte count L
...
_IOR(0xe6c8)
FLOWEQ0CTL; ///< Register 0xE6C8: CTL-Pin States in Flowstate (when Logic = 0)
_IOR(0xe6c9)
FLOWEQ1CTL; ///< Register 0xE6C9: CTL-Pin States in Flowstate (when Logic = 1)
...
_IOR(0xe6cc)
FLOWSTBEDGE; ///< Register 0xE6CC: Flowstate Rising/Falling Edge Configuration
...
_IOR(0xe6d3)
EP2GPIFPFSTOP; ///< Register 0xE6D3: Endpoint 2 GPIF Stop Transaction on
               ///< Programmable flag
...
_IOR(0xe6db)
EP4GPIFPFSTOP; ///< Register 0xE6DB: Endpoint 4 GPIF Stop Transaction on
               ///< Programmable Flag
...
_IOR(0xe6e3)
EP6GPIFPFSTOP; ///< Register 0xE6E3: Endpoint 6 GPIF Stop Transaction on
               ///< Programmable flag
...
_IOR(0xe6eb)
EP8GPIFPFSTOP; ///< Register 0xE6EB: Endpoint 8 GPIF Stop Transaction on
               ///< Programmable flag
...
_IOR(0xe6f1)
XGPIFSGLDATLX; ///< Register 0xE6F1: Read/Write GPIF Data L & trigger
               ///< transaction
_IOR(0xe6f2)
XGPIFSGLDATLNOX; ///< Register 0xE6F2: Read GPIF Data L, no transaction trigger
_IOR(0xe6f3)
GPIFREADYCFG; ///< Register 0xE6F3: Internal RDY, Sync/Async, RDY pin states
...
_IOR(0xf000)
EP2FIFOBUF[1024]; ///< Register 0xF000: 512/1024 byte EP 2 / slave FIFO buffer
                  ///< (IN or OUT)
_IOR(0xf400)
EP4FIFOBUF[512]; ///< Register 0xF400: 512 byte EP 4 / slave FIFO buffer (IN or
                 ///< OUT)
_IOR(0xf800)
EP6FIFOBUF[1024]; ///< Register 0xF800: 512/1024 byte EP 6 / slave FIFO buffer
                  ///< (IN or OUT)
_IOR(0xfc00)
EP8FIFOBUF[512]; ///< Register 0xFC00: 512 byte EP 8 / slave FIFO buffer (IN or
                 ///< OUT)
...
/**
 * \name Bits from registers EP2FIFOFLGS, EP2FIFOIE, EP2FIFOIRQ, EP4FIFOFLGS,
 * EP4FIFOIE, EP4FIFOIRQ, EP6FIFOFLGS, EP6FIFOIE, EP6FIFOIRQ, EP8FIFOFLGS,
 * EP8FIFOIE, EP8FIFOIRQ, FIFOPINPOLAR
 * @{
 */
...
/**
 * \name Bits from registers EP2ISOINPKTS, EP4ISOINPKTS, EP6ISOINPKTS,
 * EP8ISOINPKTS
 * @{
 */
...
/**
 * \name Bits from registers EP0CS, EP1INCS, EP1OUTCS, EP2CS, EP4CS, EP6CS,
 * EP8CS
 * @{
 */
...
/**
 * \name Bits from registers EP2GPIFFLGSEL, EP4GPIFFLGSEL, EP6GPIFFLGSEL,
 * EP8GPIFFLGSEL, FLOWSTATE
 * @{
 */
...
/**
 * \name Bits from registers EP2GPIFPFSTOP, EP4GPIFPFSTOP, EP6GPIFPFSTOP,
 * EP8GPIFPFSTOP
 * @{
 */
